...
//            } https://tk2.zaojiao365.net:4949/ https://tk2.zaojiao365.net:4949/m/col/97/jpbb.jpg
            ...
            $pic_lists['data'][$k]['s3_pictureUrl'] = $pic_lists['data'][$k]['pictureUrl'];
            $pic_lists['data'][$k]['s3_prefix_pictureUrl'] = $pic_lists['data'][$k]['previousPictureUrl'];
...
//            $pic_lists['data'][$k]['previousPictureUrl'] = $this->getPicUrl($list['color'], $previous[$list['lotteryType']] - 1, $list['pic_other']['keyword'], $list['lotteryType']);
            ...
            $pic_lists['data'][$k]['previousPictureUrl'] = $this->getPicUrl($list['color'], $previous[$list['lotteryType']] - 1, $list['pic_other']['keyword'], $list['lotteryType']); // , 'jpg', $params['lotteryType']==3?2024:2023
            if ( ($list['lotteryType'] == 2 || $list['lotteryType'] == 1) && Str::startsWith($pic_lists['data'][$k]['previousPictureUrl'], 'https://tk2.tuku.fit')) {
                $pic_lists['data'][$k]['previousPictureUrl'] = Str::replace('/m/', '/', $pic_lists['data'][$k]['previousPictureUrl']);
            }
                        ...
                        if (is_array($urlPrefixArr)) {
                            foreach ($urlPrefixArr as $vv) {
                                if (in_array($v['pictureTypeId'], $this->_am_pictureIds)) { // https://am.tuku.fit/galleryfiles/system/m/col/2024/128/ammh.jpg
                                    $list[$k]['largePictureUrl'] = str_replace([$vv . 'm/col/', $vv . 'col/', $vv . '/col/'], 'https://amtk.tuku.fit/galleryfiles/system/big-pic/col/' . $v['pic_other']['year'] . '/', $list[$k]['largePictureUrl']);
                                    $list[$k]['preLargePictureUrl'] = str_replace([$vv . 'm/col/', $vv . 'col/', $vv . '/col/'], 'https://amtk.tuku.fit/galleryfiles/system/big-pic/col/' . $v['pic_other']['year'] . '/', $list[$k]['preLargePictureUrl']);
